...
| [`carnet-poesie/`](https://invoxiaehu.github.io/artefacts-/carnet-poesie/) | **Carnet de poésie** — lire et réciter des poèmes : import depuis Wikisource (API MediaWiki, CORS, sans clé ni backend), révision vers à vers avec score d'apprentissage (moyenne mobile exponentielle), tirages pondérés, tags et listes, sauvegarde locale et partage du carnet complet dans le fragment d'URL (`#v=1&data=`, gzip + Base64URL). Installable sur l'écran d'accueil et lisible sans connexion. |
