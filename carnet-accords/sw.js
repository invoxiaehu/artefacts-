/* Service worker de « Carnet d'accords ».
 *
 ...
 *    l'installation.
 */
const CACHE = "carnet-accords-v6aae98df";
const CACHE_PREFIX = "carnet-accords-v";
const SHELL = ["./","./index.html","./app.js?v=7695c24b","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
const VENDOR = [{"url":"./vendor/pdf.min.js","bytes":320004},{"url":"./vendor/pdf.worker.min.js","bytes":1087212},{"url":"./vendor/chordsheet.min.js","bytes":356534}];
const FONTS = "https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@500;600;700&family=Archivo:wght@400;500;600&family=JetBrains+Mono:wght@700&display=swap";
